...
```{r plotly-export-svg, out.width='100%', message=FALSE, echo=TRUE, cache=FALSE}
...
suppressMessages(
  rD <- RSelenium::rsDriver(
                     browser = "chrome",
                     ## browser = "phantomjs", # not successful
                     verbose = FALSE)
)
...
## move saved file
copy <- file.copy(from = svg_fromfile, to = svg_tofile, overwrite = TRUE)
unlink(svg_fromfile)
```
